...
| Cor | Token delta correspondente |
| Ícone | Opcional, para reforço visual |
| Tooltip | Explicação adicional no hover |

Exemplo: uma crise pode estar "Ativa", "Monitorando", "Resolvida", "Arquivada" ou "Em análise".
...
[Valor]          ← text-3xl, font-mono, font-bold
[Delta]          ← DeltaChip com trend e cor
```
